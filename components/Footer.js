  ...
  <footer className="grid gap-4 grid-cols-1 md:grid-cols-4 p-4 md:p-8 bg-base-200 text-base-content">
    ...
    <div>
      ...
      <ul className="space-y-2">
        ...
        <li><a className="link link-hover block" rel="noreferrer" target="_blank" href="http://www.codingchaskalab.com/coding-problems">Coding Problems</a></li>
        <li><a className="link link-hover block" rel="noreferrer" target="_blank" href="http://www.codingchaskalab.com">Write Code Online</a></li>
